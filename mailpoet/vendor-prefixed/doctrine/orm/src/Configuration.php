...
class Configuration extends \MailPoetVendor\Doctrine\DBAL\Configuration
{
 ...
 public function newDefaultAnnotationDriver($paths = [], $useSimpleAnnotationReader = \true, bool $reportFieldsWhereDeclared = \false)
 {
 ...
 return new AnnotationDriver($reader, (array) $paths, $reportFieldsWhereDeclared);
 }
