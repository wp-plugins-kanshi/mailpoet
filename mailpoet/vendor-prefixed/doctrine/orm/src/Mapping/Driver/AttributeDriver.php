...
class AttributeDriver extends CompatibilityAnnotationDriver
{
 ...
 throw new LogicException('The attribute metadata driver cannot be enabled on PHP 7. Please upgrade to PHP 8 or choose a different' . ' metadata driver.');
 }
 ...
 throw MappingException::invalidIndexConfiguration($className, (string) ($indexAnnot->name ?? $idx));
 }
 ...
 throw MappingException::invalidUniqueConstraintConfiguration($className, (string) ($uniqueConstraintAnnot->name ?? $idx));
 }
